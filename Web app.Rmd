...
# Metric no longer included, no longer of interest in our research. 
...
observeEvent(input$maximinCalc, {
  ...
  df=maximin(data=obj, objectives=colnames(obj)[-c(1,2,4)], percentile = rep(input$maximinPercentile, 8))
